<template>
  <div class="px-5 pt-2 pb-4">
    ...
    <div class="space-y-3 fade-in-up stagger-1">
      ...
      >
        <!-- Parent Header -->
        <div class="flex items-center space-x-3 px-5 py-3.5">
          <div
        ...
        <!-- Sub Category Pills -->
        <div class="px-5 pb-4">
          <div v-if="p.children.length" class="flex flex-wrap -ml-2 -mt-2">
            <div
              v-for="c in p.children"
              :key="c.id"
              class="inline-flex items-center justify-center space-x-1.5 min-w-[64px] px-3 py-1.5 ml-2 mt-2 rounded-lg bg-sand text-xs"
