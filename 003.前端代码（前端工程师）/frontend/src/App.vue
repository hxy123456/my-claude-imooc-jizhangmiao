<template>
  <div class="h-screen flex flex-col bg-cream overflow-hidden">
    <!-- Main Content (iOS: -webkit-overflow-scrolling 平滑滚动 + overscroll-contain 阻止橡皮筋穿透) -->
    <div ref="scrollContainer" class="flex-1 overflow-y-auto overscroll-contain pb-[calc(5rem+env(safe-area-inset-bottom))]" style="-webkit-overflow-scrolling: touch">
        ...
        >
          ...
          <div class="relative w-full max-w-xs bg-cream rounded-3xl p-6 shadow-2xl shadow-bark/30 fade-in-up">
            ...
            <div class="flex space-x-2">
              ...
              >
                <span v-if="loggingOut" class="inline-flex items-center space-x-1.5">
